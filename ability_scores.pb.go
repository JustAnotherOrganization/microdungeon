...
func (AbilityType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

// Ability is a standard D&D ability.
type Ability struct {
	Type  AbilityType `protobuf:"varint,1,opt,name=type,enum=microdungeon.AbilityType" json:"type,omitempty"`
...
type Modifier struct {
	...
	Die  int32       `protobuf:"varint,3,opt,name=die" json:"die,omitempty"`
}

func (m *Modifier) Reset()                    { *m = Modifier{} }
func (m *Modifier) String() string            { return proto.CompactTextString(m) }
func (*Modifier) ProtoMessage()               {}
func (*Modifier) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func init() { proto.RegisterFile("ability_scores.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 286 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0x94, 0x90, 0x51, 0x4b, 0xc3, 0x30,
