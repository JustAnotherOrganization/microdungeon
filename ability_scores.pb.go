...
func (AbilityType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ability_scores_852835ae9262c134, []int{0}
}
...
func (m *Ability) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Ability.Unmarshal(m, b)
}
func (m *Ability) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Ability.Marshal(b, m, deterministic)
}
func (dst *Ability) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Ability.Merge(dst, src)
}
func (m *Ability) XXX_Size() int {
	return xxx_messageInfo_Ability.Size(m)
}
...
func (*Score) Descriptor() ([]byte, []int) {
	return fileDescriptor_ability_scores_852835ae9262c134, []int{1}
}
...
func (*Modifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_ability_scores_852835ae9262c134, []int{2}
}
...
func init() {
	proto.RegisterFile("ability_scores.proto", fileDescriptor_ability_scores_852835ae9262c134)
}

var fileDescriptor_ability_scores_852835ae9262c134 = []byte{
