...
func (Ammunition_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{0, 0} }
...
func (Weapon_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{1, 0} }
...
type Ammunition struct {
	...
	DamageType    DamageType      `protobuf:"varint,4,opt,name=damage_type,json=damageType,enum=microdungeon.DamageType" json:"damage_type,omitempty"`
	Type          Ammunition_Type `protobuf:"varint,5,opt,name=type,enum=microdungeon.Ammunition_Type" json:"type,omitempty"`
	...
	RangeModifier uint32          `protobuf:"varint,9,opt,name=range_modifier,json=rangeModifier" json:"range_modifier,omitempty"`
}
...
func (*Ammunition) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
type Weapon struct {
	...
	Aliases          []string    `protobuf:"bytes,2,rep,name=aliases" json:"aliases,omitempty"`
	Description      string      `protobuf:"bytes,3,opt,name=description" json:"description,omitempty"`
	WeightClass      WeightClass `protobuf:"varint,4,opt,name=weight_class,json=weightClass,enum=microdungeon.WeightClass" json:"weight_class,omitempty"`
	Type             Weapon_Type `protobuf:"varint,5,opt,name=type,enum=microdungeon.Weapon_Type" json:"type,omitempty"`
	Wc               *Calculator `protobuf:"bytes,6,opt,name=wc" json:"wc,omitempty"`
	Modifiers        []*Modifier `protobuf:"bytes,7,rep,name=modifiers" json:"modifiers,omitempty"`
	StealthAdvantage bool        `protobuf:"varint,8,opt,name=stealth_advantage,json=stealthAdvantage" json:"stealth_advantage,omitempty"`
	Weight           uint32      `protobuf:"varint,9,opt,name=weight" json:"weight,omitempty"`
	Thrown           bool        `protobuf:"varint,10,opt,name=thrown" json:"thrown,omitempty"`
	Reach            bool        `protobuf:"varint,12,opt,name=reach" json:"reach,omitempty"`
	TwoHanded        bool        `protobuf:"varint,13,opt,name=two_handed,json=twoHanded" json:"two_handed,omitempty"`
	Versatile        bool        `protobuf:"varint,14,opt,name=versatile" json:"versatile,omitempty"`
	...
	Wielded bool `protobuf:"varint,100,opt,name=wielded" json:"wielded,omitempty"`
}

func (m *Weapon) Reset()                    { *m = Weapon{} }
func (m *Weapon) String() string            { return proto.CompactTextString(m) }
func (*Weapon) ProtoMessage()               {}
func (*Weapon) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
type Weapon_DamageType struct {
	DamageType DamageType `protobuf:"varint,15,opt,name=damage_type,json=damageType,enum=microdungeon.DamageType,oneof"`
}
...
func _Weapon_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Weapon_DamageType:
		...
		b.EncodeVarint(uint64(x.DamageType))
...
type Weapon_ProjectileAttributes struct {
	Type         Ammunition_Type `protobuf:"varint,1,opt,name=type,enum=microdungeon.Ammunition_Type" json:"type,omitempty"`
	PerShot      uint32          `protobuf:"varint,2,opt,name=per_shot,json=perShot" json:"per_shot,omitempty"`
	RangeMin     uint32          `protobuf:"varint,3,opt,name=range_min,json=rangeMin" json:"range_min,omitempty"`
	RangeMax     uint32          `protobuf:"varint,4,opt,name=range_max,json=rangeMax" json:"range_max,omitempty"`
	MagazineSize uint32          `protobuf:"varint,5,opt,name=magazine_size,json=magazineSize" json:"magazine_size,omitempty"`
	ReloadTime   uint32          `protobuf:"varint,6,opt,name=reload_time,json=reloadTime" json:"reload_time,omitempty"`
}
...
func (*Weapon_ProjectileAttributes) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1, 0} }
...
func init() { proto.RegisterFile("weapon.proto", fileDescriptor9) }
