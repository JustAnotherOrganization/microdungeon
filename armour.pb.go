...
func (Armour_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{0, 0} }
...
type Armour struct {
	...
	Type             Armour_Type `protobuf:"varint,5,opt,name=type,enum=microdungeon.Armour_Type" json:"type,omitempty"`
	...
	Worn             bool        `protobuf:"varint,100,opt,name=worn" json:"worn,omitempty"`
}

func (m *Armour) Reset()                    { *m = Armour{} }
func (m *Armour) String() string            { return proto.CompactTextString(m) }
func (*Armour) ProtoMessage()               {}
func (*Armour) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func init() { proto.RegisterFile("armour.proto", fileDescriptor2) }

var fileDescriptor2 = []byte{
	// 412 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0x6c, 0x92, 0xc1, 0x6b, 0xdb, 0x30,
